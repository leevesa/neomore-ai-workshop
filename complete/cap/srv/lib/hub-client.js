...
module.exports = {
  ...
  /** Presence ping. Supplying a participant ID lets the Hub verify the task. */
  sendHeartbeat(participantId, password) {
    const body = participantId ? { participantId } : undefined
    return request('POST', `/heartbeat`, body, password)
  },
