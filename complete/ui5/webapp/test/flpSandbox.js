		...
		services: {
						...
						'groups': [{
							'tiles': [{
								...
								'properties': {
									...
									'targetURL': '#fineomoretemplate-display'
								}
							}]
						}]
					}
			...
			'ClientSideTargetResolution': {
				'adapter': {
					'config': {
						'inbounds': {
							'fineomoretemplate-display': {
								'semanticObject': 'fineomoretemplate',
								'action': 'display',
								'description': 'Template Fiori application',
								'title': 'Template Application',
								'signature': {
									'parameters': {}
								},
								'resolutionResult': {
									...
									'additionalInformation': 'SAPUI5.Component=fi.neomore.template',
									'url': sap.ui.require.toUrl('fi/neomore/template')
								}
							}
						}
					}
